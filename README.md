...
- Episode scraping uses IMDb season pages and TVmaze episode APIs. Control it with `CATALOG_EPISODES_ENABLED`, `CATALOG_IMDB_EPISODE_SEASON`, `CATALOG_IMDB_EPISODE_LIMIT`, and `CATALOG_TVMAZE_EPISODE_LIMIT`.
